window.$ = window.$ || (typeof $ !== 'undefined' ? $ : null);
...
const moment = /* @__PURE__ */ getDefaultExportFromCjs(dayjs_minExports);
var uikit$1 = { exports: {} };
/*! UIkit 3.24.0 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */
var uikit = uikit$1.exports;
var hasRequiredUikit;
function requireUikit() {
  if (hasRequiredUikit) return uikit$1.exports;
  hasRequiredUikit = 1;
  (function(module, exports) {
    (function(global, factory) {
      ...
      function startsWith(str, search) {
        var _a2;
        return (_a2 = str == null ? void 0 : str.startsWith) == null ? void 0 : _a2.call(str, search);
      }
      function endsWith(str, search) {
        var _a2;
        return (_a2 = str == null ? void 0 : str.endsWith) == null ? void 0 : _a2.call(str, search);
      }
      function includes(obj, search) {
        var _a2;
        return (_a2 = obj == null ? void 0 : obj.includes) == null ? void 0 : _a2.call(obj, search);
      }
      function findIndex(array, predicate) {
        var _a2;
        return (_a2 = array == null ? void 0 : array.findIndex) == null ? void 0 : _a2.call(array, predicate);
      }
      ...
      function pick(obj, props2) {
        return props2.reduce((res, prop) => __spreadProps(__spreadValues({}, res), { [prop]: obj[prop] }), {});
      }
      ...
      function contain(dimensions2, maxDimensions) {
        dimensions2 = __spreadValues({}, dimensions2);
      ...
      function attr(element, name, value) {
        ...
        if (isUndefined(value)) {
          return (_a2 = toNode(element)) == null ? void 0 : _a2.getAttribute(name);
        } else {
      ...
      function parent(element) {
        var _a2;
        return (_a2 = toNode(element)) == null ? void 0 : _a2.parentElement;
      }
      ...
      function _query(selector, context = document, queryFn) {
        ...
        for (let sel of parsed2.selectors) {
          ...
          if (sel[0] === "!") {
            ...
            ctx = (_a2 = context.parentElement) == null ? void 0 : _a2.closest(positionSel);
            if (!sel && isSingle) {
              return ctx;
            }
          }
      ...
      function getEventPos(e) {
        var _a2, _b2;
        const { clientX: x, clientY: y } = ((_a2 = e.touches) == null ? void 0 : _a2[0]) || ((_b2 = e.changedTouches) == null ? void 0 : _b2[0]) || e;
        return { x, y };
      }
      const cssNumber = {
      ...
      function resetProps(element, props2) {
      ...
      function transition$1(element, props2, duration = 400, timing = "linear", skipReflow) {
        ...
        return Promise.all(
          toNodes(element).map(
            (element2) => new Promise((resolve, reject) => {
              ...
              css(element2, __spreadValues(__spreadValues({}, transitionProps), props2));
            })
          )
        );
      }
      ...
      function isTag(element, ...tagNames) {
        return tagNames.some((tagName) => {
          var _a2;
          return ((_a2 = element == null ? void 0 : element.tagName) == null ? void 0 : _a2.toLowerCase()) === tagName.toLowerCase();
        });
      }
      ...
      function applyFn(fn) {
        return function(ref, element) {
          ...
          (_a2 = $(ref)) == null ? void 0 : _a2[fn](...nodes);
      ...
      class MouseTracker {
        ...
        cancel() {
          var _a2;
          (_a2 = this.unbind) == null ? void 0 : _a2.call(this);
      ...
      function post(el, cmd) {
        el.contentWindow.postMessage(JSON.stringify(__spreadValues({ event: "command" }, cmd)), "*");
      }
      ...
      function attachTo(element, target, options) {
        let { attach, offset: offsetBy } = __spreadValues({
          attach: __spreadValues({
            element: ["left", "top"],
            target: ["left", "top"]
          }, options.attach),
      ...
      function applyOffset(position2, offset2, i) {
        ...
        const newPos = __spreadValues({}, position2);
      ...
      function flipAxis(element, target, options) {
        return getPosition(element, target, __spreadProps(__spreadValues({}, options), {
          attach: {
      ...
      strats.computed = strats.methods = function(parentVal, childVal) {
        return childVal ? parentVal ? __spreadValues(__spreadValues({}, parentVal), childVal) : childVal : parentVal;
      };
      ...
      function lazyload(options = {}) {
        return intersection(__spreadValues({
      ...
      function fade(action, target, duration, stagger = 0) {
        ...
        const isCurrentIndex = () => index2 === transitionIndex(target);
        const wrapIndexFn = (fn) => () => isCurrentIndex() ? fn() : Promise.reject();
        const leaveFn = wrapIndexFn(() => __async(null, null, function* () {
          addClass(target, clsLeave);
          yield stagger ? getTransitionNodes(target).reduce((promise, child, i, array) => __async(null, null, function* () {
            yield promise;
            if (!isInView(child) || !isCurrentIndex()) {
              css(child, propsOut);
              return;
            }
            yield awaitTimeout(stagger);
            const transition2 = Transition.start(child, propsOut, duration / 2, "ease");
            if (array.length - 1 === i) {
              yield transition2;
            }
        ...
        const enterFn = wrapIndexFn(() => __async(null, null, function* () {
          ...
          if (stagger) {
            ...
            transitions = nodes.reduce((promise, child, i, array) => __async(null, null, function* () {
              yield promise;
              if (!isInView(child) || !isCurrentIndex()) {
              ...
              yield awaitTimeout(stagger);
              const transition2 = Transition.start(child, propsIn, duration / 2, "ease").then(
          ...
          if (!stagger || oldHeight !== newHeight) {
            const targetProps = __spreadValues({ height: newHeight }, stagger ? {} : propsIn);
            transitions.push(Transition.start(target, targetProps, targetDuration, "ease"));
          }
          yield Promise.all(transitions);
          removeClass(target, clsEnter);
          if (isCurrentIndex()) {
            resetProps(target, __spreadValues({ height: "", alignContent: "" }, propsIn));
      ...
      function slide(action, target, duration) {
        return __async(this, null, function* () {
          ...
          const targetProps = __spreadProps(__spreadValues({}, css(target, ["height", "padding"])), { display: "block" });
          const transitionNodes = nodes.filter((node) => isInView(node));
          const targets = nodes.concat(target);
          yield Promise.all(targets.map(Transition.cancel));
      ...
      function getProps$1(el, opacity) {
        ...
        return isVisible(el) ? __spreadValues({
          display: "",
      ...
      function getPositionWithMargin(el) {
        ...
        const viewport2 = offsetViewport(el.ownerDocument);
        top = clamp(top, viewport2.top - height2 - viewport2.height, viewport2.bottom + viewport2.height);
        left = clamp(left, viewport2.left - width2 - viewport2.width, viewport2.right + viewport2.width);
        return __spreadValues({
          height: height2,
          width: width2,
          top,
      ...
      var filter = {
        ...
        methods: {
          ...
          setState(state, animate2 = true) {
            return __async(this, null, function* () {
              state = __spreadValues({ filter: { "": "" }, sort: [] }, state);
      ...
      function preventBackgroundScroll(el) {
        ...
        css(scrollingElement2, props2);
        return () => {
          prevented = false;
          off2();
          resetProps(scrollingElement2, props2);
        };
      }
      var Container = {
        props: {
                  ...
                  toNodes(targets).map((el) => {
                    ...
                    const done = () => {
                      ...
                      if (show) {
                        ...
                        (_a2 = $$("[autofocus]", el).find(isVisible)) == null ? void 0 : _a2.focus();
                        restoreScrollPosition();
                      }
                    };
      ...
      function toggleTransition(_0, _1, _2) {
        return __async(this, arguments, function* (el, show, { animation, duration, velocity, transition: transition2, _toggle }) {
          var _a2;
          const [mode = "reveal", startProp = "top"] = ((_a2 = animation[0]) == null ? void 0 : _a2.split("-")) || [];
          const dirs2 = [
            ["left", "right"],
            ["top", "bottom"]
          ];
          ...
          try {
            yield Transition.start(el, endProps, duration, transition2);
          } finally {
            css(el, prevProps);
      ...
      function animate$1(el, show, { transitionElement, _toggle }) {
        return new Promise(
          (resolve, reject) => once(el, "show hide", () => {
            var _a2;
            (_a2 = el._reject) == null ? void 0 : _a2.call(el);
            el._reject = reject;
            _toggle(el, show);
            const off2 = once(
              transitionElement,
      ...
      function Transitioner$1(prev, next, dir, { animation, easing }) {
        ...
        return {
          ...
          reset() {
            resetProps([next, prev], props2[0]);
          },
          forward(_0) {
            return __async(this, arguments, function* (duration, percent22 = this.percent()) {
              yield this.cancel();
      ...
      var I18n = {
        ...
        methods: {
          t(key, ...params) {
            var _a2, _b2, _c2;
            let i = 0;
            return ((_c2 = ((_a2 = this.i18n) == null ? void 0 : _a2[key]) || ((_b2 = this.$options.i18n) == null ? void 0 : _b2[key])) == null ? void 0 : _c2.replace(
              /%s/g,
              () => params[i++] || ""
            )) || "";
          }
      ...
      function registerWatch(instance, watch, name) {
        instance._watches.push(__spreadValues({
          name
      ...
      function resetComputed(instance) {
        const values = __spreadValues({}, instance._computed);
        instance._computed = {};
        return values;
      }
      ...
      function callHook(instance, hook) {
        var _a2;
        (_a2 = instance.$options[hook]) == null ? void 0 : _a2.forEach((handler) => handler.call(instance));
      }
      ...
      function component(name, options) {
        ...
        const opt = (_a2 = options.options) != null ? _a2 : __spreadValues({}, options);
        opt.id = id2;
        opt.name = name;
        (_b2 = opt.install) == null ? void 0 : _b2.call(opt, App, opt, name);
      ...
      function detachFromElement(element, instance) {
        var _a2;
        (_a2 = element[DATA]) == null ? true : delete _a2[instance.$options.name];
          ...
          updateNav() {
            ...
            for (const el of this.navItems) {
              ...
              if (isNumeric(cmd)) {
                ...
                button.ariaSelected = active2;
                button.tabIndex = active2 && !this.parallax ? null : -1;
      ...
      var Slider = {
        ...
        methods: {
          show(index2, force = false) {
            return __async(this, null, function* () {
              ...
              if (!force && stack.length > 1) {
                if (stack.length === 2) {
                  (_a2 = this._transitioner) == null ? void 0 : _a2.forward(Math.min(this.duration, 200));
                }
                return;
              }
              ...
              trigger(next, "itemshow", [this]);
              yield this._show(prev, next, force);
          ...
          _show(prev, next, force) {
            return __async(this, null, function* () {
              this._transitioner = this._getTransitioner(prev, next, this.dir, __spreadValues({
      ...
      var Slideshow = {
        ...
        computed: {
          animation({ animation, Animations: Animations2 }) {
            return __spreadProps(__spreadValues({}, Animations2[animation] || Animations2.slide), { name: animation });
          },
          transitionOptions() {
      ...
      var Animations$1 = __spreadProps(__spreadValues({}, Animations$2), {
        fade: {
          show() {
      ...
      var Animations = __spreadProps(__spreadValues({}, Animations$2), {
        fade: {
          show() {
            ...
            handler(_, item) {
              return __async(this, null, function* () {
                ...
                if (type === "image" || isImage(src)) {
                  ...
                  attr(img2, __spreadValues(__spreadValues({
                    src
                  ...
                  const video = createEl("video", __spreadValues({
                    src,
                    playsinline: "",
                  ...
                  this.setItem(
                    item,
                    createEl("iframe", __spreadValues({
                      src,
                      allowfullscreen: "",
                  ...
                  this.setItem(
                    item,
                    createEl("iframe", __spreadValues(__spreadValues({
                  ...
                  try {
                    const { height: height2, width: width2 } = yield (yield fetch(
      ...
      var lightbox = {
        ...
        methods: {
          show(index2) {
            ...
            this.panel = this.panel || this.$create("lightboxPanel", __spreadProps(__spreadValues({}, this.$props), { items }));
            on(this.panel.$el, "hidden", () => this.panel = null);
            return this.panel.show(index2);
          },
          hide() {
            var _a2;
            return (_a2 = this.panel) == null ? void 0 : _a2.hide();
          }
        }
      };
      ...
      var notification = {
        ...
        connected() {
          return __async(this, null, function* () {
            ...
            yield Transition.start(css(this.$el, this.startProps), {
              opacity: 1,
        ...
        methods: {
          close(immediate) {
            return __async(this, null, function* () {
              ...
              if (!immediate) {
                yield Transition.start(this.$el, this.startProps);
              }
              removeFn(this.$el);
            });
          }
      ...
      var Media = {
        ...
        disconnected() {
          var _a2;
          (_a2 = this.offMediaObj) == null ? void 0 : _a2.call(this);
        }
      };
      ...
      function getMaxPathLength(el) {
        return isVisible(el) ? Math.ceil(
          Math.max(0, ...$$("[stroke]", el).map((stroke) => {
            var _a2;
            return ((_a2 = stroke.getTotalLength) == null ? void 0 : _a2.call(stroke)) || 0;
          }))
        ) : 0;
      }
      const props = {
      ...
      function transformFn(prop, el, stops) {
        ...
        if (prop === "x" || prop === "y") {
          ...
          transformFn2 = (stop2) => {
            var _a2;
            return getUnit([stop2]) ? toPx(stop2, "width", el, true) / el[`offset${((_a2 = stop2.endsWith) == null ? void 0 : _a2.call(stop2, "vh")) ? "Height" : "Width"}`] : toFloat(stop2);
          };
        }
        if (stops.length === 1) {
      ...
      function getUnit(stops, defaultUnit) {
        ...
        for (const stop2 of stops) {
          const match2 = (_a2 = stop2.match) == null ? void 0 : _a2.call(stop2, unitRe);
          if (match2) {
            return match2[1];
          }
        }
      ...
      function Transitioner(prev, next, dir, { center, easing, list }) {
        ...
        return {
          ...
          forward(_0) {
            return __async(this, arguments, function* (duration, percent2 = this.percent()) {
              yield this.cancel();
      ...
      var sortable = {
        ...
        watch: {
          ...
          handles(handles, prev) {
            const props2 = { touchAction: "none", userSelect: "none" };
            resetProps(prev, props2);
            css(handles, props2);
          }
        },
        update: {
        ...
        methods: {
          init(e) {
            ...
            this.origin = __spreadValues({ target, index: index(placeholder) }, this.pos);
        ...
        methods: {
          ...
          hide() {
            return __async(this, null, function* () {
              ...
              clearTimeout(this.showTimer);
              if (this.isToggled(this.tooltip || null)) {
                yield this.toggleElement(this.tooltip, false, false);
              }
              (_a2 = this.reset) == null ? void 0 : _a2.call(this);
          ...
          _show(title, id2) {
            return __async(this, null, function* () {
              ...
              if (!(yield this.toggleElement(this.tooltip, true))) {
                this.hide();
              }
            });
          }
      ...
      function parseProps(options) {
        ...
        return ["delay", "title"].reduce((obj, key) => __spreadValues({ [key]: data(el, key) }, obj), __spreadValues(__spreadValues({}, parseOptions(data(el, id2), ["title"])), data$1));
      }
      var upload = {
        mixins: [I18n],
        i18n: {
        ...
        methods: {
          upload(files) {
            return __async(this, null, function* () {
              ...
              const upload2 = (files2) => __async(this, null, function* () {
        ...
        for (const { addedNodes, removedNodes, target, attributeName } of records) {
          ...
          if (name) {
            if (hasAttr(target, attributeName)) {
              ...
              (_a2 = getComponent(target, name)) == null ? void 0 : _a2.$destroy();
            }
          }
        }
      }
        ...
        computed: {
          ...
          contents({ content }) {
            return this.items.map((item) => {
              var _a2;
              return ((_a2 = item._wrapper) == null ? void 0 : _a2.firstElementChild) || $(content, item);
            });
          }
        },
        watch: {
        ...
        events: [
          {
            ...
            handler(e) {
              return __async(this, null, function* () {
                ...
                maybeDefaultPreventClick(e);
                (_a2 = this._off) == null ? void 0 : _a2.call(this);
                this._off = keepScrollPosition(e.target);
                yield this.toggle(index(this.toggles, e.current));
                this._off();
              });
            }
          },
      ...
      function transition(_0, _1, _2) {
        return __async(this, arguments, function* (el, show, { content, duration, velocity, transition: transition2 }) {
          var _a2;
          content = ((_a2 = el._wrapper) == null ? void 0 : _a2.firstElementChild) || $(content, el);
          if (!el._wrapper) {
          ...
          yield Transition.cancel(wrapper);
          hide(content, false);
          ...
          yield Transition.start(wrapper, { height: show ? endHeight : 0 }, duration, transition2);
          unwrap(content);
          delete el._wrapper;
          if (!show) {
            hide(content, true);
      ...
      var alert = {
        ...
        methods: {
          close() {
            return __async(this, null, function* () {
              yield this.toggleElement(this.$el, false, animate);
              this.$destroy(true);
            });
          }
        }
      ...
      var Video = {
        ...
        beforeConnect() {
          const isVideo2 = isTag(this.$el, "video");
          if (this.autoplay === "inview" && isVideo2 && !hasAttr(this.$el, "preload")) {
            this.$el.preload = "none";
          }
          if (!isVideo2 && !hasAttr(this.$el, "allow")) {
      ...
      var cover = {
        ...
        update: {
          read() {
            ...
            const { $el, width: width2 = $el.clientWidth, height: height2 = $el.clientHeight } = this;
      ...
      function listenForBackgroundClose(drop2) {
        return on(document, pointerDown$1, ({ target }) => {
          ...
          once(
            ...
            ({ defaultPrevented, type, target: newTarget }) => {
              var _a2;
              if (!defaultPrevented && type === pointerUp$1 && target === newTarget && !((_a2 = drop2.targetEl) == null ? void 0 : _a2.contains(target))) {
                drop2.hide(false);
              }
            },
            true
      ...
      var Dropnav = {
          ...
          dropdowns({ clsDrop }, $el) {
            ...
            if (this.dropContainer !== $el) {
              for (const el of $$(`.${clsDrop}`, this.dropContainer)) {
                const target = (_a2 = this.getDropdown(el)) == null ? void 0 : _a2.targetEl;
            ...
            handler(e) {
              ...
              if (keyCode === keyMap.DOWN) {
                if ((active2 == null ? void 0 : active2.targetEl) === current) {
                  e.preventDefault();
                  (_a2 = $(selFocusable, active2.$el)) == null ? void 0 : _a2.focus();
                } else {
                  const dropdown = this.dropdowns.find(
                    (el) => {
                      var _a22;
                      return ((_a22 = this.getDropdown(el)) == null ? void 0 : _a22.targetEl) === current;
                    }
                  );
                  if (dropdown) {
                    e.preventDefault();
                    ...
                    once(dropdown, "show", (e2) => {
                      var _a22;
                      return (_a22 = $(selFocusable, e2.target)) == null ? void 0 : _a22.focus();
                    });
                  }
                }
              }
          ...
          },
          {
            ...
            handler(e) {
              ...
              if (keyCode === keyMap.HOME) {
                ...
                (_a2 = active2.targetEl) == null ? void 0 : _a2.focus();
              }
              if (~next) {
                e.preventDefault();
        ...
        methods: {
          getActive() {
            var _a2;
            return includes(this.dropdowns, (_a2 = active) == null ? void 0 : _a2.$el) && active;
          },
          transitionTo(newHeight, el) {
            return __async(this, null, function* () {
              ...
              yield Transition.cancel([el, dropbar]);
              if (el) {
      ...
      function handleNavItemNavigation(e, toggles, active2) {
        ...
        if (keyCode === keyMap.HOME) {
          ...
          (_a2 = active2.targetEl) == null ? void 0 : _a2.focus();
          (_b2 = active2.hide) == null ? void 0 : _b2.call(active2, false);
        }
        if (~next) {
          e.preventDefault();
          (_c2 = active2.hide) == null ? void 0 : _c2.call(active2, false);
          toggles[getIndex(next, toggles, toggles.indexOf(active2.targetEl || current))].focus();
        }
      }
      function preventInitialPointerEnter(el) {
        const off2 = () => handlers.forEach((handler) => handler());
        const handlers = [
          once(el.ownerDocument, pointerMove$1, (e) => el.contains(e.target) || off2()),
          on(el, `mouseenter ${pointerEnter}`, (e) => e.stopPropagation(), { capture: true }),
          on(el, `mouseleave ${pointerLeave}`, off2, { capture: true })
        ];
      }
      var formCustom = {
        mixins: [Class],
        ...
        update() {
          ...
          const value = ((_a2 = input.files) == null ? void 0 : _a2[0]) ? input.files[0].name : matches(input, "select") && (option = $$("option", input).filter((el) => el.selected)[0]) ? option.textContent : input.value;
          if (prev !== value) {
            target[prop] = value;
          }
        },
      ...
      const Spinner = {
        ...
        methods: {
          getSvg() {
            return __async(this, null, function* () {
              const icon = yield Icon.methods.getSvg.call(this);
              if (this.ratio !== 1) {
      ...
      function install({ modal: modal2 }) {
        modal2.dialog = function(content, options) {
          const dialog = modal2($(`<div><div class="uk-modal-dialog">${content}</div></div>`), __spreadValues({
            stack: true,
            role: "alertdialog"
          }, options));
          dialog.show();
        ...
        function openDialog(tmpl, options, hideFn = noop, submitFn = noop) {
          options = __spreadProps(__spreadValues({
            ...
            i18n: __spreadValues(__spreadValues({}, modal2.i18n), options == null ? void 0 : options.i18n)
          });
          ...
          write({ overflow }) {
            for (let i = 0; i < 2; i++) {
              ...
              if (!overflow[i - 1]) {
                ...
                const percent2 = overflow[i] ? this.$el[`scroll${dir}`] / overflow[i] : 0;
                const toValue = (value) => overflow[i] ? clamp((this.fadeDuration - value) / this.fadeDuration) : 1;
                css(this.$el, {
                  "--uk-overflow-fade-start-opacity": toValue(percent2),
                  "--uk-overflow-fade-end-opacity": toValue(1 - percent2)
                });
              }
            }
          },
          ...
          scrollTo(el) {
            return __async(this, null, function* () {
              ...
              if (trigger(this.$el, "beforescroll", [this, el])) {
                yield scrollIntoView(el, { offset: this.offset });
      ...
      var scrollspy = {
            ...
            write(data2) {
              for (const [el, state] of this.elementData.entries()) {
                if (state.show && !state.inview && !state.queued) {
                  state.queued = true;
                  data2.promise = (data2.promise || Promise.resolve()).then(() => __async(this, null, function* () {
                    yield awaitTimeout(state.show ? this.delay : 0);
                    this.toggle(el, true);
                    setTimeout(() => {
                      state.queued = false;
                      this.$emit();
        ...
        methods: {
          toggle(el, inview) {
            var _a2, _b2;
            const state = (_a2 = this.elementData) == null ? void 0 : _a2.get(el);
            if (!state) {
              return;
            }
            (_b2 = state.off) == null ? void 0 : _b2.call(state);
        ...
        update: [
          {
            ...
            write({ active: active2 }) {
              const { elements } = this;
              const changed = active2 !== false && !hasClass(elements[active2], this.cls);
              this.links.forEach((el) => el.blur());
              for (let i = 0; i < elements.length; i++) {
                toggleClass(elements[i], this.cls, +i === active2);
              }
              if (changed) {
                trigger(this.$el, "active", [active2, elements[active2]]);
              }
            },
            events: ["scroll", "resize"]
          }
          ...
          getSvg() {
            return __async(this, null, function* () {
              if (isTag(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy") {
                yield new Promise((resolve) => once(this.$el, "load", resolve));
              }
              return parseSVG(yield loadSVG(this.src), this.icon) || Promise.reject("SVG not found.");
            });
          }
        }
      };
      ...
      const loadSVG = memoize((src) => __async(null, null, function* () {
        if (src) {
      ...
      var Switcher = {
        ...
        update() {
          ...
          for (const index2 in this.toggles) {
            const toggle2 = this.toggles[index2];
            const item = (_a2 = this.connects[0]) == null ? void 0 : _a2.children[index2];
            toggle2.role = "tab";
            if (!item) {
              continue;
            }
        ...
        methods: {
          ...
          show(item) {
            ...
            this.connects.forEach((_0) => __async(this, [_0], function* ({ children: children2 }) {
              const actives = toArray(children2).filter(
                (child, i) => i !== active2 && hasClass(child, this.cls)
              );
              if (yield this.toggleElement(actives, false, animate2)) {
                yield this.toggleElement(children2[active2], true, animate2);
              }
            }));
          }
        }
        ...
        methods: {
          toggle(type) {
            return __async(this, null, function* () {
              ...
              if (yield this.toggleElement(toggled, false)) {
                yield this.toggleElement(
  ...
  return uikit$1.exports;
}
var uikitExports = requireUikit();
const UIKit = /* @__PURE__ */ getDefaultExportFromCjs(uikitExports);
export {
  UIKit as U,
...
//# sourceMappingURL=uikit-CBbQtaHN.js.map
