...
// Схема пользователя с правильной коллекцией
...
}, { collection: 'accounts' }); // Указываем правильную коллекцию
...
async function createAdminInAccounts() {
  try {
    // Удаляем всех пользователей из коллекции accounts
    ...
    // Создаем пользователя в коллекции accounts
    ...
    console.log('Admin user created in accounts collection!');
    console.log('Username: admin');
    console.log('Password: password');
    console.log('User ID:', admin._id);
    
    // Тестируем поиск пользователя как в приложении
